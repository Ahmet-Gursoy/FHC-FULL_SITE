...
$dbname = "fhc";
    ...
    try {
        ...
        $pdo_hizmet->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        
        // Hizmetleri getir
        $stmt = $pdo_hizmet->prepare("SELECT * FROM hizmetler ORDER BY id ASC");
        $stmt->execute();
    ...
    <div class="container py-5">
        ...
        <div class="row justify-content-center g-4">
            ...
            <?php if (!empty($hizmetler)): ?>
                    ...
                    <div class="col-md-5 col-lg-4">
                        <div class="card shadow-lg p-3">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div>
                                    <h5 class="text-danger fw-semibold"><?php echo htmlspecialchars($hizmet['baslik']); ?></h5>
                                    <p class="mb-0"><?php echo htmlspecialchars($hizmet['aciklama']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
                <!-- Varsayılan hizmet kartı - veritabanında kayıt yoksa -->
                <div class="col-md-5 col-lg-4">
                    <div class="card shadow-lg p-3">
                        <div class="d-flex align-items-start gap-3">
                            <i class="bi bi-heart-fill text-danger fs-2"></i>
                            <div>
                                <h5 class="text-danger fw-semibold">Hizmet Bulunamadı</h5>
                                <p class="mb-0">Lütfen admin panelinden hizmetleri ekleyiniz.</p>
                            </div>
                        </div>
                    </div>
                </div>
